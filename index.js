...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/immutable/dist/immutable.js":[function(require,module,exports) {
var define;
...
module.exports = "/logo.3aa6aa1e.svg";
},{}],"Information.tsx":[function(require,module,exports) {
"use strict";
...
var Field = /** @class */function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        return React.createElement("p", null, React.createElement("label", { htmlFor: id }, this.props.label), React.createElement("input", { value: this.props.value, id: id, onChange: function onChange(e) {
                return _this.props.set(e.currentTarget.value);
...
var Information = /** @class */function (_super) {
    ...
    Information.prototype.render = function () {
        var _this = this;
        var name = function name(k) {
            return { name: k, value: _this.props.information.get(k), set: _this.props.set(k) };
        };
        return React.createElement("div", { className: "information" }, React.createElement(Field, __assign({ label: "\u540D\u79F0" }, name("name"))), React.createElement(Field, __assign({ label: "\u73A9\u5BB6" }, name("player"))), React.createElement(Field, __assign({ label: "\u804C\u4E1A" }, name("occupation"))), React.createElement(Field, __assign({ label: "\u6027\u522B" }, name("sex"))), React.createElement(Field, __assign({ label: "\u5C45\u4F4F\u5730" }, name("residence"))), React.createElement(Field, __assign({ label: "\u51FA\u751F\u5730" }, name("birthplace"))));
    };
    return Information;
}(React.Component);
exports.Information = Information;
exports.default = Information;
},{"react":"../node_modules/react/index.js"}],"fields/NumberInput.tsx":[function(require,module,exports) {
"use strict";
...
var NumberInput = /** @class */function (_super) {
    ...
    NumberInput.prototype.render = function () {
        ...
        var update = function update(v) {
            if (/^\d+$/.test(v)) {
                var number = Number(v);
                if (_this.props.editable && _this.props.onChange !== undefined && !isNaN(number) && number <= _this.props.max) {
                    _this.props.onChange(Number(v));
                }
            } else if (v == "" && _this.props.onChange !== undefined) {
                _this.props.onChange(0);
            }
        };
        return React.createElement("input", { id: id, type: "number", className: this.props.className, disabled: !this.props.editable, value: this.value(), onChange: function onChange(e) {
                return update(e.currentTarget.value);
            } });
    };
    NumberInput.prototype.value = function () {
...
},{"react":"../node_modules/react/index.js"}],"utils.ts":[function(require,module,exports) {
"use strict";
...
function roll(n, face) {
    ...
    return Array.from(array).map(Number).map(function (x) {
        return x % face + 1;
    });
}
},{}],"Characteristics.tsx":[function(require,module,exports) {
'use strict';
...
var _NumberInput = require('./fields/NumberInput');
...
var Field = /** @class */function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        var hint = this.props.children;
        if (hint === undefined && max !== undefined && value !== undefined && value > max) {
            hint = React.createElement("span", null, label, '\u6700\u591A', max);
        }
        return React.createElement("p", null, React.createElement("label", { htmlFor: id }, label), React.createElement(_NumberInput2.default, { value: value, onChange: set, id: id, className: "field number-field characteristics-field" }), hint);
    };
    return Field;
}(React.PureComponent);
var AgeField = /** @class */function (_super) {
    __extends(AgeField, _super);
    function AgeField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.auto_age = function () {
            return [0, 0, 0, 0].map(function () {
                return (0, _utils.randomIntFromInterval)(15, 90);
            }).reduce(function (a, b) {
                return Math.min(a, b);
            }, 100);
        };
    ...
    AgeField.prototype.render = function () {
        var _this = this;
        var age = this.props.value;
        var hint = null;
        if (age !== undefined) {
            if (age < 15 || age > 90) {
                hint = React.createElement("span", null, '\u8D85\u8FC7\u89C4\u5219\u8303\u56F4\uFF0C\u8BF7\u54A8\u8BE2\u4E3B\u6301\u4EBA\u3002');
            } else if (age < 20) {
                hint = React.createElement("span", null, '\u529B\u91CF\u548C\u4F53\u578B\u5408\u8BA1\u51CF 5 \u70B9\u3002\u6559\u80B2\u51CF5\u70B9\u3002 \u51B3\u5B9A\u5E78\u8FD0\u503C\u65F6\u53EF\u4EE5\u9AB0 2 \u6B21\u5E76\u53D6\u8F83\u597D\u7684\u4E00\u6B21\u3002');
            } else if (age < 40) {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C1\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002');
            } else if (age < 50) {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C2\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002\u529B\u91CF\u4F53\u8D28\u654F\u6377\u5408\u8BA1\u51CF 5 \u70B9\u3002\u5916\u8C8C\u51CF 5 \u70B9\u3002');
            } else if (age < 60) {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C3\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002\u529B\u91CF\u4F53\u8D28\u654F\u6377\u5408\u8BA1\u51CF 10 \u70B9\u3002\u5916\u8C8C\u51CF 10 \u70B9\u3002');
            } else if (age < 70) {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C4\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002\u529B\u91CF\u4F53\u8D28\u654F\u6377\u5408\u8BA1\u51CF 20 \u70B9\u3002\u5916\u8C8C\u51CF 15 \u70B9\u3002');
            } else if (age < 80) {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C4\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002\u529B\u91CF\u4F53\u8D28\u654F\u6377\u5408\u8BA1\u51CF 40 \u70B9\u3002\u5916\u8C8C\u51CF 20 \u70B9\u3002');
            } else {
                hint = React.createElement("span", null, '\u5BF9\u6559\u80B2\u8FDB\u884C4\u6B21\u589E\u5F3A\u68C0\u5B9A\u3002\u529B\u91CF\u4F53\u8D28\u654F\u6377\u5408\u8BA1\u51CF 80 \u70B9\u3002\u5916\u8C8C\u51CF 25 \u70B9\u3002');
            }
        }
        return React.createElement(Field, __assign({}, this.props), React.createElement("button", { onClick: function onClick() {
                return _this.props.set(_this.auto_age());
            } }, '\u968F\u673A\u5E74\u9F84'), hint);
    };
    return AgeField;
}(React.PureComponent);
var Characteristics = /** @class */function (_super) {
    __extends(Characteristics, _super);
    function Characteristics() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.auto_roll = function () {
            var r = function r(n, face) {
                return (0, _utils.roll)(n, face).reduce(function (x, y) {
                    return x + y;
                });
            };
            var attr = _this.props.attributes;
            var next = attr.merge({
                str: r(3, 6) * 5,
                con: r(3, 6) * 5,
                siz: (r(2, 6) + 6) * 5,
            ...
            _this.props.set(next);
        };
        return _this;
    }
    Characteristics.prototype.shouldComponentUpdate = function (next) {
        return !this.props.attributes.equals(next.attributes);
    };
    Characteristics.prototype.render = function () {
        var _this = this;
        var name = function name(k) {
            return {
                name: k,
                value: _this.props.attributes.get(k),
                set: function set(v) {
                    return _this.props.set(_this.props.attributes.set(k, v));
                }
            };
        };
        return React.createElement("div", { className: "characteristics" }, React.createElement(AgeField, __assign({ label: '\u5E74\u9F84', max: 99 }, name("age"))), React.createElement("p", null, '\u70B9\u4E00\u4E0B\u8FD9\u91CC', React.createElement("button", { onClick: this.auto_roll }, '\u81EA\u52A8 roll \u70B9')), React.createElement(Field, __assign({ label: '\u529B\u91CF', max: 99 }, name("str"))), React.createElement(Field, __assign({ label: '\u4F53\u8D28', max: 99 }, name("con"))), React.createElement(Field, __assign({ label: '\u4F53\u578B' }, name("siz"))), React.createElement(Field, __assign({ label: '\u654F\u6377', max: 99 }, name("dex"))), React.createElement(Field, __assign({ label: '\u5916\u8C8C', max: 99 }, name("app"))), React.createElement(Field, __assign({ label: '\u667A\u529B', max: 99 }, name("int"))), React.createElement(Field, __assign({ label: '\u610F\u5FD7' }, name("pow"))), React.createElement(Field, __assign({ label: '\u6559\u80B2', max: 99 }, name("edu"))), React.createElement(Field, __assign({ label: '\u5E78\u8FD0', max: 99 }, name("luck"))));
    };
    return Characteristics;
}(React.Component);
exports.default = Characteristics;
},{"react":"../node_modules/react/index.js","./fields/NumberInput":"fields/NumberInput.tsx","./utils":"utils.ts"}],"Status.tsx":[function(require,module,exports) {
"use strict";
...
var Field = /** @class */function (_super) {
    ...
    function Field(props) {
        ...
        if (props.max !== undefined) {
            _this.state = { value: props.max, edited: false };
        } else {
            _this.state = { edited: false };
        }
        return _this;
    }
    Field.prototype.render = function () {
        ...
        var updater = function updater(v) {
            return _this.setState({ value: v, edited: true });
        };
        return React.createElement("p", null, React.createElement("label", { htmlFor: label }, label), React.createElement(_NumberInput2.default, { max: max, id: label, value: this.state.edited ? value : max, onChange: updater }), " / ", max);
    };
    return Field;
}(React.Component);
var Status = /** @class */function (_super) {
    ...
    Status.prototype.render = function () {
        return React.createElement("div", { className: "status" }, React.createElement(Field, { label: "SAN", max: this.san() }), React.createElement(Field, { label: "MP", max: this.mp() }), React.createElement(Field, { label: "HP", max: this.hp() }), React.createElement("div", null, "\u79FB\u52A8\u529B\uFF1A", this.mov()));
    };
    Status.prototype.san = function () {
        return this.props.attributes.get("pow");
    };
    Status.prototype.mp = function () {
        var pow = this.props.attributes.get("pow");
        if (pow !== undefined) {
            return (0, _utils.div)(pow, 5);
        } else {
            return undefined;
        }
    };
    Status.prototype.hp = function () {
        var siz = this.props.attributes.get("siz");
        var con = this.props.attributes.get("con");
    ...
    Status.prototype.mov = function () {
        var dex = this.props.attributes.get("dex");
        var str = this.props.attributes.get("str");
        var siz = this.props.attributes.get("siz");
        var age = this.props.attributes.get("age");
        if ([dex, str, siz, age].some(function (x) {
            return x === undefined;
        })) {
            return undefined;
        }
...
},{"react":"../node_modules/react/index.js","./utils":"utils.ts","./fields/NumberInput":"fields/NumberInput.tsx"}],"Skills.tsx":[function(require,module,exports) {
"use strict";
...
var skills = [{ label: "心理学", en: "Psychology", initial: 10, tag: [] }, { label: "信用评级", en: "Credit Rating", initial: 0, tag: [] }, { label: "话术", en: "Fast Talk", initial: 5, tag: [] }, { label: "恐吓", en: "Intimidate", initial: 15, tag: [] }, { label: "魅惑", en: "Charm", initial: 15, tag: [] }, { label: "说服", en: "Persuade", initial: 10, tag: [] }, { label: "领航", en: "Navigate", initial: 10, tag: [] }, { label: "生存", en: "Survival", initial: 10, tag: ["blank"] }, { label: "跳跃", en: "Jump", initial: 20, tag: [] }, { label: "攀爬", en: "Climb", initial: 15, tag: [] }, { label: "游泳", en: "Swim", initial: 20, tag: [] }, { label: "汽车驾驶", en: "Drive Auto", initial: 20, tag: [] }, { label: "驾驶", en: "Pilot", initial: 1, tag: ["blank"] }, { label: "骑术", en: "Ride", initial: 5, tag: [] }, { label: "潜行", en: "Stealth", initial: 20, tag: [] }, { label: "追踪", en: "Track", initial: 10, tag: [] }, { label: "乔装", en: "Disguise", initial: 5, tag: [] }, { label: "锁匠", en: "Locksmith", initial: 1, tag: [] }, { label: "妙手", en: "Sleight of Hand", initial: 10, tag: [] }, { label: "会计", en: "Accounting", initial: 5, tag: [] }, { label: "法律", en: "Law", initial: 5, tag: [] }, { label: "神秘学", en: "Occult", initial: 5, tag: [] }, { label: "历史", en: "History", initial: 5, tag: [] }, { label: "人类学", en: "Anthropology", initial: 1, tag: [] }, { label: "考古学", en: "Archaeology", initial: 1, tag: [] }, { label: "博物学", en: "Natural World", initial: 10, tag: [] }, { label: "电子学", en: "Electronics", initial: 1, tag: ["modern"] }, {
    label: "科学", en: "Science", initial: 1, tag: [], contains: [{ label: "天文学", en: "Astronomy", initial: 1 }, { label: "地质学", en: "Geology", initial: 1 }, { label: "气象学", en: "Meteorology", initial: 1 }, { label: "生物学", en: "Biology", initial: 1 }, { label: "司法科学", en: "Forensics", initial: 1 }, { label: "药学", en: "Pharmacy", initial: 1 }, { label: "植物学", en: "Botany", initial: 1 }, { label: "物理学", en: "Physics", initial: 1 }, { label: "化学", en: "Chemistry", initial: 1 }, { label: "密码学", en: "Cryptography", initial: 1 }, { label: "动物学", en: "Zoology", initial: 1 }, { label: "数学", en: "Mathematics", initial: 1 }]
}, { label: "侦查", en: "Spot Hidden", initial: 25, tag: [] }, { label: "聆听", en: "Listen", initial: 20, tag: [] }, { label: "图书馆利用", en: "Library Use", initial: 20, tag: [] }, { label: "估价", en: "Appraise", initial: 5, tag: [] }, { label: "克苏鲁神话", en: "Cthulhu Mythos", initial: 0, tag: [] }, { label: "精神分析", en: "Psychoanalysis", initial: 1, tag: [] }, { label: "急救", en: "First Aid", initial: 30, tag: [] }, { label: "医学", en: "Medicine", initial: 1, tag: [] }, { label: "催眠", en: "Hypnosis", initial: 1, tag: ["irregular"] }, { label: "闪避", en: "Dodge", initial: "dex/2", tag: [] }, {
    label: "格斗", en: "Fighting", initial: 10, tag: [], contains: [{ label: "斗殴", en: "Brawl", initial: 25 }, { label: "剑", en: "Sword", initial: 20 }, { label: "矛", en: "Spear", initial: 20 }, { label: "斧头", en: "Axe", initial: 15 }, { label: "绞索", en: "Garrote", initial: 15 }, { label: "电锯", en: "Chainsaw", initial: 10 }, { label: "连枷", en: "Flail", initial: 10 }, { label: "鞭子", en: "Whip", initial: 5 }]
}, { label: "投掷", en: "Throw", initial: 20, tag: [] }, {
    label: "射击", en: "Firearms", initial: 10, tag: [], contains: [{ label: "弓术", en: "Bow", initial: 15 }, { label: "手枪", en: "Handgun", initial: 20 }, { label: "步枪/霰弹枪", en: "Rifle/Shotgun", initial: 25 }, { label: "冲锋枪", en: "Submachine Gun", initial: 15 }, { label: "火焰喷射器", en: "Flamethrower", initial: 10 }, { label: "重武器", en: "Heavy Weapons", initial: 10 }, { label: "机关枪", en: "Machine Gun", initial: 10 }]
}, { label: "操作重型机械", en: "Operate Heavy Machinery", initial: 1, tag: [] }, { label: "机械维修", en: "Mechanical Repair", initial: 10, tag: [] }, { label: "电气维修", en: "Electrical Repair", initial: 10, tag: [] }, { label: "计算机使用", en: "Computer Use", initial: 5, tag: ["modern"] }, { label: "艺术与手艺", en: "Art and Craft", initial: 5, tag: ["blank"] }, { label: "动物驯养", en: "Animal Handling", initial: 5, tag: ["irregular"] }, { label: "读唇", en: "Read Lips", initial: 1, tag: ["irregular"] }, { label: "潜水", en: "Diving", initial: 1, tag: ["irregular"] }, { label: "炮术", en: "Artillery", initial: 1, tag: ["irregular"] }, { label: "爆破", en: "Demolitions", initial: 1, tag: ["irregular"] }, { label: "语言（其他）", en: "Language (Other)", initial: 1, tag: ["blank"] }, { label: "语言（母语）", en: "Language (Own)", initial: "edu", tag: ["blank"] }];
var SuperSkill = /** @class */function (_super) {
    __extends(SuperSkill, _super);
    function SuperSkill() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SuperSkill.prototype.render = function () {
        return null;
    };
    return SuperSkill;
}(React.Component);
var BlankSkill = /** @class */function (_super) {
    __extends(BlankSkill, _super);
    function BlankSkill() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BlankSkill.prototype.render = function () {
        return null;
    };
    return BlankSkill;
}(React.Component);
var Skill = /** @class */function (_super) {
    ...
    Skill.prototype.render = function () {
        ...
        if (this.props.contains !== undefined) {
            return React.createElement(SuperSkill, __assign({}, this.props));
        }
        if (this.props.tag.some(function (tag) {
            return tag === "blank";
        })) {
            return React.createElement(BlankSkill, __assign({}, this.props));
        }
        ...
        var is_mythos = this.props.en === "Cthulhu Mythos";
        var change = sum === initial;
        return React.createElement("tr", { className: change ? "skill-row changed" : "skill-row" }, React.createElement("td", null, React.createElement("input", { type: "checkbox", disabled: is_mythos })), React.createElement("td", null, React.createElement("ruby", null, this.props.label, React.createElement("rt", null, this.props.en))), React.createElement("td", null, initial), React.createElement("td", null, React.createElement(_NumberInput.NumberInput, { max: 100, value: occupation, editable: !is_mythos, onChange: function onChange(n) {
                return _this.setState({ occupation: n });
            } })), React.createElement("td", null, React.createElement(_NumberInput.NumberInput, { max: 100, value: interest, editable: !is_mythos, onChange: function onChange(n) {
                return _this.setState({ interest: n });
            } })), React.createElement("td", null, React.createElement(_NumberInput.NumberInput, { max: 100, value: grow, onChange: function onChange(n) {
                return _this.setState({ grow: n });
            } })), React.createElement("td", { className: sum >= 100 ? "skill-out-range" : undefined }, sum));
    };
    return Skill;
}(React.Component);
var Skills = /** @class */function (_super) {
    ...
    Skills.prototype.render = function () {
        ...
        var rows = skills.filter(function (row) {
            return row.en.includes(filter) || row.label.includes(filter);
        }).map(function (row) {
            var props = __assign({}, row);
            if (props.initial == "edu") props.initial = _this.props.attributes.get("edu", 0);else if (row.initial == "dex/2") props.initial = (0, _utils.div)(_this.props.attributes.get("dex", 0), 2);
            return React.createElement(Skill, __assign({ key: row.en }, props));
        });
        var skill_filter = React.createElement("p", null, React.createElement("label", { htmlFor: "skill-filter" }, "\u7B5B\u9009"), React.createElement("input", { id: "skill-filter", value: filter, placeholder: "\u7B5B\u9009\u6280\u80FD\u540D", onChange: function onChange(e) {
                return _this.setState({ filter: e.currentTarget.value });
            } }));
        return React.createElement("div", null, React.createElement("h2", null, "\u6280\u80FD"), skill_filter, React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null), React.createElement("th", null, "\u540D\u79F0"), React.createElement("th", null, "\u521D\u59CB\u503C"), React.createElement("th", null, "\u672C\u804C"), React.createElement("th", null, "\u5174\u8DA3"), React.createElement("th", null, "\u6210\u957F"), React.createElement("th", null, "\u5408\u8BA1")), rows)));
    };
    return Skills;
}(React.Component);
exports.Skills = Skills;
},{"react":"../node_modules/react/index.js","./fields/NumberInput":"fields/NumberInput.tsx","./utils":"utils.ts"}],"Sheet.tsx":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.SheetContext = exports.SheetData = undefined;
...
var SheetData = /** @class */function () {
    function SheetData() {
        this.attributes = (0, _immutable.Map)();
        this.information = (0, _immutable.Map)();
    }
    return SheetData;
}();
exports.SheetData = SheetData;
var SheetContext = exports.SheetContext = React.createContext(new SheetData());
var Sheet = /** @class */function (_super) {
    __extends(Sheet, _super);
    function Sheet(props) {
        var _this = _super.call(this, props) || this;
        _this.setInformation = function (key) {
            return function (value) {
                return _this.setState(__assign({}, _this.state, { information: _this.state.information.set(key, value) }));
            };
        };
        _this.setAttributes = function (next) {
            return _this.setState(__assign({}, _this.state, { attributes: next }));
        };
        _this.state = new SheetData();
        return _this;
    }
    Sheet.prototype.render = function () {
        return React.createElement(React.StrictMode, null, React.createElement(SheetContext.Provider, { value: this.state }, React.createElement("div", { className: "Sheet section" }, React.createElement("header", { className: "Sheet-header container" }, React.createElement("img", { src: _logo2.default, className: "Sheet-logo", alt: "logo" }), React.createElement("h1", { className: "Sheet-title title" }, "Chareets"), React.createElement("p", { className: "S-intro subtitle" }, '\u76EE\u524D\u662F\u4E00\u4E2A CoC 7 Edition \u4EBA\u7269\u5361\u751F\u6210\u5668'), React.createElement("p", null, '\u6B22\u8FCE\u4F60\uFF0C', this.state.information.get("name", "不知名的冒险者"))), React.createElement(_Information2.default, { information: this.state.information, set: this.setInformation }), React.createElement(_Characteristics2.default, { attributes: this.state.attributes, set: this.setAttributes }), React.createElement(_Status.Status, { attributes: this.state.attributes }), React.createElement(_Skills.Skills, { attributes: this.state.attributes }))));
    };
    return Sheet;
}(React.Component);
exports.default = Sheet;
},{"react":"../node_modules/react/index.js","immutable":"../node_modules/immutable/dist/immutable.js","./logo.svg":"logo.svg","./Information":"Information.tsx","./Characteristics":"Characteristics.tsx","./Status":"Status.tsx","./Skills":"Skills.tsx"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/bulma/css/bulma.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"registerServiceWorker.ts":[function(require,module,exports) {
'use strict';
...
ReactDOM.render(React.createElement(_Sheet2.default, null), document.getElementById('root'));
(0, _registerServiceWorker2.default)();
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./Sheet":"Sheet.tsx","./index.css":"index.css","bulma/css/bulma.css":"../node_modules/bulma/css/bulma.css","./registerServiceWorker":"registerServiceWorker.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
